...
# --- 脚本配置 (Mihomo 专用) ---
CONFIG_ZIP_URL="https://ghfast.top/github.com/Scu9277/eBPF/releases/download/mihomo/mihomo.zip"
...
install_tproxy() {
    ...
    case $t_choice in
        ...
        2)
            ...
            EBPF_DEPLOY_URL="https://ghfast.top/raw.githubusercontent.com/Scu9277/eBPF/refs/heads/main/mihomo/deploy.sh"
            ...
            if bash <(curl -sSL "$EBPF_DEPLOY_URL"); then
                ...
                echo -e "   ${CYAN}bash <(curl -sSL https://ghfast.top/raw.githubusercontent.com/Scu9277/eBPF/refs/heads/main/mihomo/check_tproxy.sh)${NC}"
            else
